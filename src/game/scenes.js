...
export const EVENT_SCENES = {
  ...
  work_emergency: {
    scene: '手机突然震了一下，一看是老板发来的消息。\n\n"在吗？有个事情比较急，需要你处理一下。"\n\n你看了看客厅里正热闹的一家人，再看看手机屏幕，心里一阵纠结。\n\n"大过年的..."你小声嘟囔了一句。',
    thoughts: '工作和过年，永远在争夺你的时间。'
  },
  work_emergency_handle_remote: {
    scene: '你跟家人打了个招呼，回到房间打开电脑。\n\n"我处理个急事，半小时就好。"\n\n妈妈端了杯茶进来："别太累了。"\n\n你花了一个多小时才搞定，出来的时候饭菜已经凉了。\n\n"给你热一下。"妈妈说。\n\n你鼻子一酸，觉得对不起家人。',
    thoughts: '过年加班，赚的是钱，亏的是陪伴。'
  },
  work_emergency_refuse_directly: {
    scene: '你想了两秒，回了一条消息："不好意思领导，我在老家过年，这个事情年后我第一时间处理。"\n\n发完之后心跳加速了几秒。\n\n过了一会，老板回了个"好吧"。\n\n你长出一口气，把手机扣在桌上。\n\n"谁啊？"妈妈问。\n\n"没事，工作上的。"你笑了笑，"来，继续吃。"',
    thoughts: '拒绝老板需要勇气，但有些时候必须给自己划条线。'
  },
  family_sick: {
    scene: '吃完午饭，妈妈突然说："你爸/你妈今天好像不太舒服。"\n\n你走过去一看，脸色确实有点发白。\n\n"没事没事，老毛病了。"家人摆摆手。\n\n"什么没事？看你脸色这么差。"你有点着急。',
    thoughts: '家人不舒服的时候，才发现平时真的太忽略他们的身体了。'
  },
  family_sick_go_hospital: {
    scene: '你二话不说，套上外套："走，去医院看看。"\n\n"不用不用，花那个钱干嘛..."\n\n"别省了，身体要紧。"你拉着家人就往外走。\n\n在医院排了一个多小时的队，好在医生说没什么大碍，开了些药。\n\n回家的路上，家人小声说："谢谢你陪我来。"\n\n"说什么呢，这不是应该的嘛。"你笑着说，心里却有点后怕。',
    thoughts: '有些钱不能省，尤其是关于家人健康的。'
  },
  ex_encounter: {
    scene: '你正在街上走着，突然一个熟悉的身影出现在对面。\n\n心跳莫名加速了一下——是前任。\n\n对方好像也看到了你，脚步顿了一下。\n\n街上人来人往，你们之间隔着三四米的距离。',
    thoughts: '有些人你以为已经忘了，但再见面的那一刻才知道并没有。'
  },
  ex_encounter_say_hello: {
    scene: '你深吸一口气，走上前笑了笑："嗨，好久不见。"\n\n"好久不见。"对方也笑了，"过年回来了？"\n\n"嗯，你也是。"\n\n你们聊了几句近况，客气得像两个刚认识的人。\n\n"那先走了，新年快乐。"\n\n"新年快乐。"\n\n转身之后，你没有回头看。',
    thoughts: '礼貌的寒暄，是给过去最体面的交代。'
  },
  ex_encounter_sit_and_chat: {
    scene: '"要不...坐一会？"你犹豫了一下还是开了口。\n\n对方想了想，点了点头。\n\n你们找了个路边的茶馆坐下来，点了两杯热茶。\n\n聊了工作、聊了家人，唯独没聊当初的事。\n\n临走时，对方说："其实，挺高兴你过得不错的。"\n\n你笑了笑，没说话。',
    thoughts: '有些话不用说出口，坐在一起喝杯茶就够了。'
  },
  unexpected_visitor: {
    scene: '"叮咚——"\n\n你去开门，门口站着一个有点面熟的中年人。\n\n"这是你三姑父的表弟！"妈妈赶紧跑过来介绍。\n\n"哦哦，叔叔好！"你连忙笑着招呼。\n\n心里想：这个亲戚关系，我得拿张纸画一下才能搞清楚。',
    thoughts: '中国式亲戚关系的复杂程度，堪比高等数学。'
  },
  unexpected_visitor_warm_welcome: {
    scene: '你赶紧让座、泡茶、端水果。\n\n妈妈从厨房端出了好几道菜："来来来，一起吃点。"\n\n远房亲戚客气了两句，然后就不客气了。\n\n一顿饭吃得宾主尽欢，临走时对方拉着你的手："这孩子真懂事，有出息。"\n\n你笑着送到门口，关上门的那一刻松了口气。',
    thoughts: '热情接待虽然累，但面子和里子都赚到了。'
  },
  childhood_teacher: {
    scene: '你在镇上走着，突然看到一个熟悉的背影。\n\n走近一看——是小学的班主任老师。\n\n头发比记忆中白了很多，走路也慢了些。\n\n你站在原地，一时不知道该不该上前。',
    thoughts: '小时候觉得老师很老，现在发现老师是真的老了。'
  },
  childhood_teacher_greet_teacher: {
    scene: '"老师！"你快步走上前。\n\n老师转过头，眯着眼看了你两秒："你是...小X？"\n\n"对对对，是我！"你高兴得不行。\n\n"长这么大了！"老师拍了拍你的肩膀，眼里有光，"在外面做什么工作？"\n\n你们站在路边聊了好一会，像是小学放学后的那种闲聊。\n\n"要好好的啊。"临走时老师说。',
    thoughts: '被老师记得的感觉，比期末考试满分还开心。'
  },
  childhood_teacher_treat_teacher: {
    scene: '"老师，我请您吃个饭吧！"\n\n"不用不用，你花什么钱..."\n\n"您就别推了，好不容易碰到。"\n\n你带老师去了镇上的小饭馆，点了几个菜。\n\n老师吃着菜，感慨地说："你们这一届的孩子，我都还记得。有调皮的，有安静的..."\n\n你听着，仿佛回到了小学教室里。\n\n"老师，谢谢您当年对我的教导。"你举起了杯子。\n\n老师笑了，眼圈微微有些红。',
    thoughts: '请老师吃饭，吃的不是菜，是二十年的师生情。'
  },
  power_outage: {
    scene: '正看着电视，"啪"的一声，屋里一片漆黑。\n\n"又停电了！"妈妈的声音从厨房传来。\n\n"别动，我去找手电。"爸爸摸黑站起来。\n\n你打开手机手电筒，照了一圈——全村/全小区都黑了。',
    thoughts: '停电这事，在城里很稀罕，在家好像是常规操作。'
  },
  power_outage_candle_chat: {
    scene: '妈妈翻出了几根蜡烛，点上之后屋里有了一种奇特的温暖感。\n\n你们围坐在一起，烛光摇曳。\n\n"没有电视看，咱们聊天吧。"你说。\n\n"你小时候也这样，一停电就缠着我讲故事。"妈妈笑着说。\n\n爸爸也打开了话匣子："我跟你说，以前停电那叫常事，哪像现在..."\n\n你们聊了小时候的事、聊了以前的邻居、聊了很多平时不会聊的话题。\n\n等电来的时候，你反而有点舍不得。',
    thoughts: '停电让我们放下手机，找回了聊天的感觉。'
  },
  online_gossip: {
    scene: '手机"叮叮叮"响个不停。\n\n你打开家族群一看，两个亲戚正在对骂。\n\n"你那个时候凭什么那么说我？"\n\n"我说的都是实话，你自己心虚！"\n\n群里其他人要么沉默，要么发"别吵了"的表情包。\n\n消息刷了几十条，情况越来越激烈。',
    thoughts: '亲戚群炸了，这比春晚精彩多了。'
  },
  online_gossip_peacemaker: {
    scene: '你想了想，打了一段话发出去：\n\n"都是一家人，大过年的别伤和气了。有什么事过完年坐下来好好说。"\n\n群里安静了几秒。\n\n一个亲戚发了个"好吧"。\n\n另一个也发了个"算了"。\n\n妈妈在旁边看了你一眼："你这话说得还行。"\n\n你苦笑："当和事佬真累。"',
    thoughts: '劝架这活儿，两边不讨好，但总得有人干。'
  },
  talent_show: {
    scene: '"来来来，表演一个！"有人突然把你推到人群中间。\n\n周围的人开始起哄："一个一个！"\n\n你看了看四周期待的眼神，有点骑虎难下。\n\n"你不是会XX吗？来一个呗！"有人喊。',
    thoughts: '社死现场还是高光时刻，就在一念之间。'
  },
  talent_show_perform: {
    scene: '你深吸一口气，清了清嗓子。\n\n开始的时候还有点紧张，但慢慢就进入状态了。\n\n表演完，现场爆发出一阵掌声和口哨声。\n\n"不错啊！藏了一手！"有人竖起了大拇指。\n\n"再来一个！"大家起哄。\n\n你笑着摆手，心里却美滋滋的。',
    thoughts: '被大家认可的感觉，真的很好。'
  },
  talent_show_drag_others: {
    scene: '"我一个人不行，得有人一起！"你一把拉住旁边的表弟/表妹。\n\n"别别别，我不行——"\n\n"走走走，一起上！"你半推半就地把人拽上了台。\n\n你们合作了一个节目，虽然有点乱，但逗得大家哈哈大笑。\n\n"你们两个太逗了！"姑姑笑得前仰后合。',
    thoughts: '一个人尬不如拉个人一起尬，快乐加倍。'
  },
  lost_wallet: {
    scene: '你摸了摸口袋——钱包不见了。\n\n翻了外套、翻了裤子、翻了书包...都没有。\n\n冷汗一下子就下来了。\n\n"我钱包呢？"你开始慌了。\n\n里面有身份证、银行卡，还有几百块现金。',
    thoughts: '钱包丢了那一刻，感觉世界都不好了。'
  },
  lost_wallet_search_carefully: {
    scene: '你按照今天走过的路线，一个地方一个地方地找。\n\n从家里到门口，从门口到街上...\n\n你弯腰看了每一个角落，问了路过的每一个人。',
    thoughts: '找东西的时候，时间过得特别慢。'
  },
  lost_wallet_ask_family: {
    scene: '"妈，你看到我钱包了吗？"你着急地问。\n\n"什么钱包？你放哪了？"妈妈开始帮你找。\n\n全家人都动员起来了，翻沙发、翻柜子、翻床底。\n\n最后在沙发缝里找到了——原来是看电视的时候滑进去的。\n\n"你这孩子，东西也不收好。"妈妈又好气又好笑。',
    thoughts: '全家总动员找钱包，虽然丢人但很温暖。'
  },
  neighbor_conflict: {
    scene: '门外突然传来吵架声。\n\n你出去一看，隔壁两家正在为一堵墙/一棵树的事情争得面红耳赤。\n\n"你这个人怎么这样？"\n\n"明明是你先..."\n\n看到你出来，一个人喊道："你来评评理！"',
    thoughts: '邻里纠纷这种事，参与容易脱身难。'
  },
  neighbor_conflict_mediate_neighbors: {
    scene: '你走上前，深吸一口气。\n\n"叔叔、阿姨，大过年的，别为这点事伤了和气。"\n\n你两边劝了半天，好说歹说终于让双方都冷静下来。\n\n"行吧，看在你的面子上，今天不计较了。"\n\n你长出一口气，感觉比上了一天班还累。',
    thoughts: '调解纠纷这事，说白了就是消耗自己的精力去换别人的和平。'
  },
  neighbor_conflict_smooth_talk: {
    scene: '你分别拉着两边的人，小声地说好话。\n\n"他其实不是那个意思..."\n\n"您大人有大量，别跟他一般见识..."\n\n你两边跑，嘴皮子都快磨破了。',
    thoughts: '两边说好话的难度，不亚于同时走两根钢丝。'
  },
  drunk_relative: {
    scene: '饭桌上，有个亲戚越喝脸越红，说话也越来越大声。\n\n"我跟你们说...嗝...我当年..."开始讲陈年往事了。\n\n旁边的家属使了好几个眼色都没用。\n\n"再来一杯！"他举起了空杯子。\n\n大家互相看了看，有点尴尬。',
    thoughts: '每个家族聚会上，总有一个喝高了的。'
  },
  drunk_relative_send_home: {
    scene: '你站起来，架住他的胳膊："叔/哥，差不多了，我送您回去吧。"\n\n"我没...没醉..."他嘴硬，腿已经不听使唤了。\n\n你半扛半拖地把他弄出了门。\n\n路上他一会儿唱歌一会儿讲人生哲理，你全程苦笑。\n\n送到家后，他家属连声道谢："麻烦你了，每次都这样..."\n\n你摆摆手，走回去的路上觉得胳膊都要废了。',
    thoughts: '送醉汉回家，是一项体力和耐力的双重考验。'
  },
  social_media_viral: {
    scene: '你打开手机，发现之前随手发的一条朋友圈突然火了。\n\n99+条消息提醒，点赞数还在涨。\n\n"这也能火？"你有点懵。\n\n评论区热闹得不行："太真实了""转发了""你说的就是我"\n\n你刷着评论，忍不住笑出了声。',
    thoughts: '莫名其妙的火了，互联网真是玄学。'
  }
}
